...
namespace Orata\Bundle\PayboxBundle\Tests\Paybox\DirectPlus;

use Orata\Bundle\PayboxBundle\Paybox\DirectPlus\Request;
use Orata\Bundle\PayboxBundle\Transport\BuzzTransport;
use Orata\Bundle\PayboxBundle\Transport\CurlTransport;

/**
 * Class RequestTest
 *
 * @package Orata\Bundle\PayboxBundle\Tests\Paybox\DirectPlus
 *
 */
class RequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function initMock(array $messages, $httpResponse = null, $dispatch = false)
    {
        ...
        foreach ($messages as $i => $message) {
            $logger
                ->expects($this->at($i))
                ->method($message[0])
                ->with(new \PHPUnit\Framework\Constraint\StringContains($message[1]))
            ;
        }
        ...
        $transport = $this->getMockForAbstractClass('Orata\Bundle\PayboxBundle\Transport\AbstractTransport');
    ...
    public function testSendSimpleAutorization()
    {
        ...
        $this->initMock(array(
            ...
            array('info', 'Result : NUMTRANS=0005329117&NUMAPPEL=0010244812&NUMQUESTION='.sprintf('%010d', $time).'&SITE=1999888&RANG=32&AUTORISATION=XXXXXX&CODEREPONSE=00000&COMMENTAIRE=Demande trait�e avec succ�s&REFABONNE=&PORTEUR='),
        ),
    ...
    public function testSendCapture()
    {
        ...
        $this->initMock(array(
            ...
            array('info', ' > DATEQ = ' . sprintf('%014s', $time)),
            array('info', 'Result : NUMTRANS='.$GLOBALS['NUMTRANS'].'&NUMAPPEL='.$GLOBALS['NUMAPPEL'].'&NUMQUESTION='.sprintf('%010d', $time).'&SITE=1999888&RANG=32&AUTORISATION=XXXXXX&CODEREPONSE=00000&COMMENTAIRE=Demande trait�e avec succ�s&REFABONNE=&PORTEUR='),
        ),
        'NUMTRANS=0005329117&NUMAPPEL=0010244812&NUMQUESTION='.sprintf('%010d', $time).'&SITE=1999888&RANG=32&AUTORISATION=XXXXXX&CODEREPONSE=00000&COMMENTAIRE=Demande trait�e avec succ�s&REFABONNE=&PORTEUR=',
        true);
    ...
    public function testSendRefund()
    {
        ...
        $this->initMock(array(
            ...
            array('info', ' > ACTIVITE = 024'),
            array('info', ' > DATEQ = '.sprintf('%014s', $time)),
            array('info', 'Result : NUMTRANS=0005329136&NUMAPPEL='.$GLOBALS['NUMAPPEL'].'&NUMQUESTION='.sprintf('%010d', $time).'&SITE=1999888&RANG=32&AUTORISATION=XXXXXX&CODEREPONSE=00000&COMMENTAIRE=Demande trait�e avec succ�s&REFABONNE=&PORTEUR='),
        ),
    ...
    public function testSendSubscriberCreationButUserAlreadyExists()
    {
        ...
        $this->initMock(array(
            ...
            array('info', ' > DATEQ = ' . sprintf('%014s', $time)),
            array('info', 'Result : NUMTRANS=0000000000&NUMAPPEL=0000000000&NUMQUESTION='.sprintf('%010d', $time).'&SITE=1999888&RANG=32&AUTORISATION=&CODEREPONSE=00016&COMMENTAIRE=PAYBOX : Abonn� d�j� existant&REFABONNE=ABODOCUMENTATION001&PORTEUR=1111222233334444'),
        ),
    ...
    public function testSendSubscriberDebit()
    {
        ...
        $this->initMock(array(
            ...
            array('info', ' > ACTIVITE = 027'),
            array('info', ' > DATEQ = ' . sprintf('%014s', $time)),
            array('info', 'Result : NUMTRANS=0005329164&NUMAPPEL=0010244857&NUMQUESTION='.sprintf('%010d', $time).'&SITE=1999888&RANG=32&AUTORISATION=XXXXXX&CODEREPONSE=00000&COMMENTAIRE=Demande trait�e avec succ�s&REFABONNE=ABODOCUMENTATION001&PORTEUR=1111222233334444'),
        ),
